<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccessRights.aspx.cs" Inherits="UltdevMP3FlashPlayer.AccessRights" %>
        ...
        <uc1:FolderTreeControl ID="folderTreeControl" runat="server" />
            ...
            <tr>
                <td align="center" colspan="2" valign="top">
                    <asp:HyperLink ID="doneHyperLink" runat="server" NavigateUrl="javascript: window.location = 'JukeBox.aspx';" Font-Size="Large">Done</asp:HyperLink></td>
            </tr>
        </table>
                    </td>
                </tr>
