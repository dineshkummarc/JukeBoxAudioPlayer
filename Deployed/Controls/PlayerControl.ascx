        ...
        <td colspan="2" nowrap="nowrap" valign="top">
            <table width="100%">
                <tr>
                    ...
                    <td align="right">Set your Default music folder by clicking here ->
        <asp:HyperLink ID="accessHyperLink" runat="server"
            NavigateUrl="~/AccessRights.aspx" ToolTip="Click to designate folder with music that will be accessible to people Listoning Music." Font-Bold="False" Font-Size="Larger">Music for Guests</asp:HyperLink></td>
                </tr>
            </table>
        </td>
    </tr>
